...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .day-header { display: flex; justify-content: space-between; align-items: center; padding: 0.75rem; background: #001943; color: white; border-radius: 8px; margin-bottom: 0.75rem; }
